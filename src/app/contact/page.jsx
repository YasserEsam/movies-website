          ...
          <div className="lg:mb-0 mb-10">
            <div className="group w-full h-full">
              <div className="relative h-full">
                ...
                {/* Add the contact details section here */}
                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                  <div className="bg-white rounded-lg p-6 block">
                    <a href="tel:470-601-1911" className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">+967 773878487</h5>
                    </a>
                    <a href="mailto:Pagedone1234@gmail.com" className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">yaaser10esam1010@gmail.com</h5>
                    </a>
                    <a href="javascript:;" className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">30 Street, Sana'a, Yemen</h5>
                    </a>
                  </div>
                </div>
              </div>
