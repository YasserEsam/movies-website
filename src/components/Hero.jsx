...
export default async function Hero({ lang }) {
  ...
  return (
    <section className="relative   min-h-[100vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="mx-auto mt-20 max-w-7xl px-6 sm:px-8 lg:px-10 relative z-10">
        <div className="flex flex-col items-center justify-center">
          {/* Centered Content Container */}
          <div className="relative w-full max-w-2xl backdrop-blur-xl bg-white/10 dark:bg-black/20 rounded-2xl p-12 border border-white/20 dark:border-white/10 shadow-2xl transform perspective-1000 hover:rotate-y-2 transition-transform duration-500">
            {/* Contained Background Effects */}
            <div className="absolute inset-0 overflow-hidden rounded-2xl">
              {/* Animated Gradient Orbs */}
              <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mix-blend-overlay filter blur-3xl opacity-10 dark:opacity-5 animate-blob"></div>
              <div className="absolute top-1/3 right-1/4 w-48 h-48 bg-gradient-to-r from-yellow-400 to-pink-400 rounded-full mix-blend-overlay filter blur-3xl opacity-10 dark:opacity-5 animate-blob animation-delay-2000"></div>
              <div className="absolute bottom-1/4 left-1/3 w-48 h-48 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full mix-blend-overlay filter blur-3xl opacity-10 dark:opacity-5 animate-blob animation-delay-4000"></div>
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="relative group mb-8 transform hover:scale-105 transition-transform duration-300 inline-block">
                ...
                <span className="relative inline-block px-6 py-3 text-sm font-medium tracking-wider text-purple-300 dark:text-purple-200 uppercase bg-white/10 dark:bg-black/20 rounded-lg backdrop-blur-sm transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-purple-500/20 border border-white/20 dark:border-white/10">
                  {dict.Hero.tagline}
                </span>
              </div>
              ...
              <p className="text-lg leading-8 text-gray-300 transition-all duration-300 hover:text-white mb-8 glass-hover p-4 rounded-lg">
                {dict.Hero.details}
              </p>
